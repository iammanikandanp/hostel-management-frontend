        ...
        {loading && (
          ...
          <form
            onSubmit={handleSubmit}
             className="form-containers bg-opacity-40  w-full w-7xl text-lg px-6 py-4   bg-black  rounded-lg shadow-md">

      
      <h2 className="form-title text-3xl  text-center text-green-500 mb-2 mt-11">Student Registration</h2>
